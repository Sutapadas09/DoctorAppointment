...
<html>
    ...
    <body>
        ...
        <%
            ...
            String path = "D:/AdvanceJava/DoctorAppointment/web/images/uploads/"+email;
            ...
            try{
                ...
                PreparedStatement ps = con.prepareStatement("update doctor set Picture=? where Email=?");
                ps.setString(1, path);
                ...
                if(ps.executeUpdate()>0){
                    ...
                    out.print("<script>window.location.href='welcomeD.jsp'</script>");
                }
            }catch(IOException e){
